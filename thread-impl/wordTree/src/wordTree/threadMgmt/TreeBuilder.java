 ...
 * @version 1.0
 * @since 10-27-2017
 * Citation -  http://www.geeksforgeeks.org/binary-search-tree-set-1-search-and-insertion/
 */
...
public class TreeBuilder {
    ...
    public void inorderRec(Node root) {
        try {
            if (root != null) {
                ...
                Node_Data.add(root);
                noWords = noWords + root.count;
                noChars = noChars + (root.word.length() * root.count);
                if(root.count > 0) {
                    noDistWords++;
                }
    ...
    public String printNodes() {
        String returnValue = "";
        try {
            returnValue = returnValue + "The total number of words: " + noWords + "\n";
            returnValue = returnValue + "The total number of characters: " + noChars + "\n";
            returnValue = returnValue + "The total number of distinct words: " + noDistWords + "\n";
